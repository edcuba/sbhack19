...
contract TrackAndTrust {
    ...
    function registerWarehouse(string memory physicalAddress) public {
        require(bytes(warehouses[msg.sender].physicalAddress).length == 0);
        warehouses[msg.sender] = Warehouse(0, physicalAddress);
    }
